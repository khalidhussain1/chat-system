                        ...
                        <div class="block-body">
                            <nav id="sidebar" style="border-right: 0px;width: auto;margin-left:-17px">
                              ...
                              <ul class="list-unstyled">
                                <li class=""><a href="{{route('designer.profile-settings')}}"> <i class="fa fa-user"></i>Profile Settings</a></li>
                                <li class="active"><a href="{{route('designer.settings')}}"> <i class="fa fa-unlock"></i>Change Password</a></li>
