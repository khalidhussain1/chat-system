...
<div class="page-content">
    ...
    {{-- <div class="page-header d-flex">
        ...
        <div class="ml-2 d-flex">
            ...
            <h2 class="h5 no-margin-bottom ml-2" id="profile" style="color: #db6574;"><a href="{{route('client.profile-settings')}}" style="text-decoration: none";>Profile Settings</a></h2>
        </div>
        <div class="ml-2 d-flex">

            <h2 class="h5 no-margin-bottom ml-2" id="settings"><a href="{{route('client.settings')}}" style="text-decoration: none";>Settings</a> </h2>
        </div>
    </div> --}}
            ...
            <div class="row">
                        ...
                        <div class="block-body">
                            <nav id="sidebar" style="border-right: 0px;width: auto;margin-left:-17px;">
                              <ul class="list-unstyled">
                                <li class="active"><a href="{{route('client.profile-settings')}}"> <i class="fa fa-user"></i>Profile Settings</a></li>
                                <li class=""><a href="{{route('client.settings')}}"> <i class="fa fa-unlock"></i>Change Password</a></li>
                              </ul>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="col-lg-8" id="profile-settings">
                    <div class="block">
                        ...
                        <div class="block-body">
                            <form class="form-horizontal" method="post" action="{{route('client.update_information')}}"  enctype='multipart/form-data'>
                                @csrf
